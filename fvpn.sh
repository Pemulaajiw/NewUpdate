...
username=$(curl https://raw.githubusercontent.com/Pemulaajiw/NewUpdate/main/ip | grep $IP_VPS | awk '{print $2}')
echo "$username" >/usr/bin/user

# Save Expired Detail in github to /usr/bin/e
expx=$(curl https://raw.githubusercontent.com/Pemulaajiw/NewUpdate/main/ip | grep $IP_VPS | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Pemulaajiw/NewUpdate/main/ip | grep $IP_VPS | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Pemulaajiw/NewUpdate/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Pemulaajiw/NewUpdate/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me@AJW29 "},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6287898083051"}]]}'
...
# install menu shell
wget https://raw.githubusercontent.com/Pemulaajiw/NewUpdate/main/feature/FVPN_sh
unzip FVPN_sh
chmod +x menu/*
...
# install menu py
wget https://raw.githubusercontent.com/Pemulaajiw/NewUpdate/main/feature/FVPN_py
unzip FVPN_py
chmod +x menu/*
mv menu/* /usr/bin
rm -rf menu
